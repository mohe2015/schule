...
`(:html :lang "en"
   ...
   (:body
    ...
    (:div :style "display: none;" :class
     ...
     (:form :method "POST" :action "/api/teachers" :id "create-teacher-form"
      ...
      (:div :class "form-group" (:label "Initialien")
       (:input :type "text" :class "form-control" :placeholder "Initialien" :name
        "initial" :id "teacher-initial"))
    ...
    (:div :style "display: none;" :class "container my-tab position-absolute" :id
     ...
     (:ul :id "articles-list"))
    (:div :style "display: none;" :class "container my-tab position-absolute" :id
     "tags" (:h1 :class "text-center" "Tags") (:ul :id "tags-list"))
    (:div :style "display: none;" :class
     ...
     (:form :method "POST" :action "/api/schedules" :id "create-schedule-form"
      (:div :class "form-group" (:label "Jahrgang")
       (:input :type "text" :class "form-control" :placeholder "Jahrgang" :name
        "grade" :id "schedule-grade"))
      (:button :type "submit" :class "btn btn-primary" "Stundenplan erstellen")))
    (html-settings)
    (:div :style "display: none;" :class "container my-tab position-absolute" :id
    ...
    (:div :style "display: none;" :class "container my-tab position-absolute" :id
     ...
     (:h2 :class "text-center" "Lehrer"
      (:a :href "/teachers/new" :type "button" :class "btn btn-primary norefresh"
       "+"))
     (:ul :id "teachers-list"))
    (:div :style "display: none;" :class "container my-tab position-absolute" :id
     "list-courses"
     (:h2 :class "text-center" "Kurse"
      (:a :href "/courses/new" :type "button" :class "btn btn-primary norefresh"
       "+"))
     (:ul :id "courses-list"))
    ...
    (:div :style "display: none;" :class
     ...
     (:div :class "alert alert-danger" :role "alert" (:span :id "errorMessage")
     ...
     (:div :class "modal-dialog" :role "document"
      (:div :class "modal-content"
       ...
       (:div :class "modal-body"
        (:form
         (:div :class "form-group"
          (:div :class "form-group" (:label :for "image-file" "Bild auswählen:")
    ...
    (:form :id "schedule-data-form"
     (:div :class "modal fade" :id "schedule-data-modal" :tabindex "-1" :role
      "dialog" :aria-labelledby "schedule-data-modal-label" :aria-hidden "true"
      (:div :class "modal-dialog" :role "document"
       (:div :class "modal-content"
        (:div :class "modal-header"
    ...
    (:link :rel "stylesheet" :href "/mathlive.css") (:script :src "/mathlive.js")
    (:script :src "/popper.js") (:script :src "/bootstrap.min.js")
