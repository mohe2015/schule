...
(defcenum argon2_errorcodes
 ...
 (:argon2_ad_too_short -8) (:argon2_ad_too_long -9)
 (:argon2_secret_too_short -10) (:argon2_secret_too_long -11)
 (:argon2_time_too_small -12) (:argon2_time_too_large -13)
 (:argon2_memory_too_little -14) (:argon2_memory_too_much -15)
 (:argon2_lanes_too_few -16) (:argon2_lanes_too_many -17)
 (:argon2_pwd_ptr_mismatch -18) (:argon2_salt_ptr_mismatch -19)
 (:argon2_secret_ptr_mismatch -20) (:argon2_ad_ptr_mismatch -21)
 (:argon2_memory_allocation_error -22) (:argon2_free_memory_cbk_null -23)
 (:argon2_allocate_memory_cbk_null -24) (:argon2_incorrect_parameter -25)
 (:argon2_incorrect_type -26) (:argon2_out_ptr_mismatch -27)
   ...
   (with-foreign-string ((pwd pwdlen) password)
    (let ((t-cost 2) (m-cost (ash 1 16)) (parallelism 1))
      (with-foreign-pointer
       (encoded
        (argon2-encodedlen t-cost m-cost parallelism *saltlen* *hashlen*
         :argon2_id)
        encodedlen)
       (assert
        (eq :argon2_ok
