...
(my-defroute :POST "/api/student-courses" (:admin :user) (|course-id|) "text/html"
  (let* ((student-course (create-dao 'student-course :student user :course (find-dao 'course :id (first |course-id|)))))
